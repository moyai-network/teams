...
func (pharaoh) Rewards() []Reward {
	return []Reward{
		...
		NewReward(item2.NewMoneyNote(2500, 1), 10),
		NewReward(item2.NewMoneyNote(5000, 1), 10),
		NewReward(item2.NewMoneyNote(7500, 1), 10),
		...
		18: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 1), 16),
		19: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 3), 24),
		20: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 5), 13),
		21: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 7), 12),
		22: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 9), 11),
