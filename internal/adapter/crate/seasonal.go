...
func (seasonal) Rewards() []Reward {
	return []Reward{
		...
		NewReward(item2.NewMoneyNote(1000, 1), 12),
		NewReward(item2.NewMoneyNote(2500, 1), 12),
		NewReward(item2.NewMoneyNote(5000, 1), 12),
		NewReward(item2.NewMoneyNote(7500, 1), 12),
		...
		18: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 1), 20),
		19: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 3), 24),
		20: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 5), 15),
		21: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 7), 14),
		22: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 9), 13),
