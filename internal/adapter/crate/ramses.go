...
func (ramses) Rewards() []Reward {
	return []Reward{
		...
		NewReward(item2.NewMoneyNote(500, 1), 10),
		NewReward(item2.NewMoneyNote(1500, 1), 10),
		NewReward(item2.NewMoneyNote(2500, 1), 10),
		NewReward(item2.NewMoneyNote(3500, 1), 10),
		...
		18: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 1), 8),
		19: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 3), 17),
		20: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 5), 6),
		21: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 7), 5),
		22: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 9), 4),
