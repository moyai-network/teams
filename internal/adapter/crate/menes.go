...
func (menes) Rewards() []Reward {
	return []Reward{
		NewReward(item.NewStack(item.Helmet{Tier: item.ArmourTierDiamond{}}, 1).WithEnchantments(append(menesEnchantments, item.NewEnchantment(enchantment2.NightVision{}, 1))...).WithCustomName(text.Colourf("<emerald>Menes Helmet</emerald>")), 10),
		...
		NewReward(item2.NewMoneyNote(250, 1), 10),
		NewReward(item2.NewMoneyNote(1000, 1), 10),
		NewReward(item2.NewMoneyNote(2000, 1), 10),
		NewReward(item2.NewMoneyNote(3000, 1), 10),
		...
		18: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 1), 5),
		19: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 3), 14),
		20: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 5), 3),
		21: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 7), 2),
		22: NewReward(item2.NewSpecialItem(item2.PartnerPackageType{}, 9), 1),
