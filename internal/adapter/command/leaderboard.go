...
func (l LeaderboardKills) Run(src cmd.Source, o *cmd.Output, tx *world.Tx) {
...
func (l LeaderboardDeaths) Run(src cmd.Source, o *cmd.Output, tx *world.Tx) {
	p, ok := src.(*player.Player)
	if !ok {
		return
	}
...
func (l LeaderboardKillStreaks) Run(src cmd.Source, o *cmd.Output, tx *world.Tx) {
	p, ok := src.(*player.Player)
	if !ok {
		return
	}
...
func (l LeaderboardKDR) Run(src cmd.Source, o *cmd.Output, tx *world.Tx) {
	p, ok := src.(*player.Player)
	if !ok {
		return
	}
