...
func (b BanLiftOffline) Run(src cmd.Source, o *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.unban", u.DisplayName)
...
func (b Ban) Run(src cmd.Source, o *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.ban", t.Name(), reason)
	internal.Broadcastf("command.ban.broadcast", s.Name(), t.Name(), reason)
...
func (b BanOffline) Run(src cmd.Source, o *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.ban", u.DisplayName, reason)
	internal.Broadcastf("command.ban.broadcast", s.Name(), u.DisplayName, reason)
