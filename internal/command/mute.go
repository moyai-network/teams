...
func (m MuteLift) Run(src cmd.Source, out *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.unmute", p.Name())
...
func (m MuteLiftOffline) Run(src cmd.Source, out *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.unmute", u.DisplayName)
...
func (m Mute) Run(src cmd.Source, out *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.mute", t.Name(), reason)
...
func (m MuteOffline) Run(src cmd.Source, out *cmd.Output) {
	...
	internal.Alertf(src, "staff.alert.mute", u.DisplayName, reason)
