...
func (a *ArmourHandler) HandleTake(ctx *inventory.Context, slot int, itm item.Stack) {
...
func (a *ArmourHandler) HandlePlace(ctx *inventory.Context, slot int, itm item.Stack) {
	p := ctx.Val().(*player.Player)
...
func (a *ArmourHandler) HandleDrop(ctx *inventory.Context, slot int, itm item.Stack) {
	p := ctx.Val().(*player.Player)
