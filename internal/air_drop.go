...
func init() {
	for _, v := range []struct {
		...
		{
			path: "assets/air_drop/parachute_offset_fence_1.json",
			dst:  parachuteFenceOffsets,
		},
		{
			path: "assets/air_drop/parachute_offset_wool_1.json",
			dst:  parachuteWoolOffsets,
		},
		{
			path: "assets/air_drop/parachute_offset_fence_2.json",
			dst:  parachuteFenceOffsets2,
		},
		{
			path: "assets/air_drop/parachute_offset_wool_2.json",
			dst:  parachuteWoolOffsets2,
		},
		{
			path: "assets/air_drop/parachute_offset_fence_3.json",
			dst:  parachuteFenceOffsets3,
		},
		{
			path: "assets/air_drop/parachute_offset_wool_3.json",
			dst:  parachuteWoolOffsets3,
		},
		{
			path: "assets/air_drop/parachute_offset_fence_4.json",
			dst:  parachuteFenceOffsets4,
		},
		{
			path: "assets/air_drop/parachute_offset_wool_4.json",
			dst:  parachuteWoolOffsets4,
		},
		{
			path: "assets/air_drop/parachute_offset_fence_5.json",
			dst:  parachuteFenceOffsets5,
		},
		{
			path: "assets/air_drop/parachute_offset_wool_5.json",
			dst:  parachuteWoolOffsets5,
		},
	} {
		err := gophig.GetConfComplex(v.path, gophig.JSONMarshaler{}, v.dst)
		if err != nil {
			panic(err)
		}
	}
