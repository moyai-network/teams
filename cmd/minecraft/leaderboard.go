...
func startLeaderboard() {
	...
	for range t.C {
		...
		topPointsLeaderboard.SetNameTag(formattedTeamLeaderBoard("POINTS", func(t model.Team) int {
			return t.Points
		}))

		topKOTHLeaderboard.SetNameTag(formattedTeamLeaderBoard("KOTH CAPTURES", func(t model.Team) int {
			return t.KOTHWins
		}))
