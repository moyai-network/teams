...
func (*handler) HandleTake(ctx *event.Context, a int, it item.Stack) {
	ctx.Cancel()
}

func (*handler) HandlePlace(ctx *event.Context, a int, it item.Stack) {
	ctx.Cancel()
}

func (*handler) HandleDrop(ctx *event.Context, a int, it item.Stack) {
	ctx.Cancel()
}
