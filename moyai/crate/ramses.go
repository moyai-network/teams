...
func (ramses) Rewards() []Reward {
	return []Reward{
		...
		18: NewReward(it.NewPartnerPackage(1), 8),
		19: NewReward(it.NewPartnerPackage(3), 17),
		20: NewReward(it.NewPartnerPackage(5), 6),
		21: NewReward(it.NewPartnerPackage(7), 5),
		22: NewReward(it.NewPartnerPackage(9), 4),
